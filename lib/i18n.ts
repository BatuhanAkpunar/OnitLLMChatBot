...
const en = {
  ...
  teamWorking: "Onit's team is working ({x}/{n})",
  synthWorking: "Onit is wrapping up the team's work",
  teamContributed: "Team contributions: {roles}",
...
const tr: Record<I18nKey, string> = {
  ...
  you: "Sen",
  exportedNote: "Onit AI'dan dışa aktarıldı",
  exportBrief: "Özet",
  ...
  teamWorking: "Onit ekibi çalışıyor ({x}/{n})",
  synthWorking: "Onit ekibin işini topluyor",
  teamContributed: "Ekip katkıları: {roles}",
